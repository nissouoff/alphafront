...
const translations = {
  fr: {
    ...
    onboarding2Step2: "Choisissez un template",
    onboarding2Step2Desc: "Sélectionnez le template qui vous convient pour créer votre page de vente.",
  ...
  ar: {
    ...
    onboarding2Step2: "اختر قالب",
    onboarding2Step2Desc: "حدد القالب المناسب لإنشاء صفحة البيع.",
  ...
  en: {
    ...
    onboarding2Step2: "Choose a template",
    onboarding2Step2Desc: "Select the template that suits you to create your sales page.",
