        ...
        <>
          ...
          `}>
            ...
            <nav className="flex-1 p-4 space-y-2">
              ...
              <Link href="/dashboard/landings" onClick={() => setMobileMenuOpen(false)} className={`flex items-center gap-3 px-4 py-3 ${isActive("/dashboard/landings") ? "bg-[var(--theme-button)]/20 text-[var(--theme-button)] rounded-xl font-medium" : `${textMuted} hover:bg-[var(--theme-card)]/80 rounded-xl transition-colors`}`} data-guide="landing-btn">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
