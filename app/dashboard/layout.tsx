        ...
        <>
          ...
          `}>
            ...
            <nav className="flex-1 p-4 space-y-2">
              ...
              <Link href="/dashboard/analytics" onClick={() => setMobileMenuOpen(false)} className={`flex items-center gap-3 px-4 py-3 ${isActive("/dashboard/analytics") ? "bg-[var(--theme-button)]/20 text-[var(--theme-button)] rounded-xl font-medium" : `${textMuted} hover:bg-[var(--theme-card)]/80 rounded-xl transition-colors`} onboarding-orders`}>
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
                <span className="onboarding-orders">Analytics</span>
              </Link>
